...
export default async function DusuncelerPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Atık deyince ne geliyor?</h1>
      ...
      <section>
        ...
        <p className="mb-4 text-sm text-slate-500">
          {cevaplar.length} kayıtlı cevap · Sık yazılanlar daha büyük görünür · Veriler kalıcı
          saklanır
        </p>
